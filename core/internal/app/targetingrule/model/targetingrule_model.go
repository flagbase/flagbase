...
type TargetingRule struct {
	...
	Operator       flagset.Operator    `json:"operator,omitempty" jsonapi:"attr,operator,omitempty"`
	Negate         bool                `json:"negate,omitempty" jsonapi:"attr,negate,omitempty"`
	RuleVariations []flagset.Variation `json:"ruleVariations" jsonapi:"attr,ruleVariations"`

...
// Project Project
//
// A project is a collection of environments and their respective flags.
//
...
type Project struct {
	...
	// tags
	Tags ResouceName `json:"tags,omitempty"`
}
...
func (m *Project) validateKey(formats strfmt.Registry) error {

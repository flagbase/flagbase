...
function License(): JSX.Element {
  ...
  return (
    <Layout title={"License"} description="Licensing for all things open-source. Flagbase OSS is licensed under MLP-2.0.">
      <header
      ...
      >
        <div className="container">
          <h3 className="hero__title">License</h3>
          <p className="hero__subtitle">
            Licensing for all things open-source.
          </p>
        </div>
      </header>
      <main className="container">
        <h3 className="section__title">MPL-2.0</h3>
        <p className="paragraph-text">
          All Flagbase OSS projects are licensed under{" "}
          <a href="https://www.mozilla.org/en-US/MPL/2.0/" target="_blank">
            MPL-2.0 (aka Mozilla Public License 2.0)
          </a>
          .{" "}
        </p>
        <section className="license-block">
          ...
          <h3 id="limitations-on-grant-scope">
          ...
          <p>
            ...
            Section&nbsp;10.3, no one other than the license steward has the
            right to modify or publish new versions of this License. Each
        ...
        <h3 className="section__title">Compliance</h3>
        <p className="paragraph-text">
          Flagbase OSS goes through extensive license dependecy checking
          (powered by{" "}
          ...
          <a
            href="https://app.fossa.com/reports/39d990ec-3b64-4665-a6d4-0342d3084a1b"
            target="_blank"
          >
            Click here
          </a>{" "}
          for a live project report. The license checker listens to all changes
          to the master branch and re-runs on every new commit.
        </p>
        <p>
          <a
            href="https://app.fossa.com/projects/git%2Bgithub.com%2Fflagbase%2Fflagbase?ref=badge_large"
            alt="FOSSA Status"
            target="_blank"
          >
            <img src="https://app.fossa.com/api/projects/git%2Bgithub.com%2Fflagbase%2Fflagbase.svg?type=large" />
          </a>
        </p>
      </main>
    </Layout>

...
1. Register to recieve access credentials. These credentials will allow you to connect to the instance. 
Currently, the cloud service is invite-only. If you wish to recieve access, fill out [this form](https://forms.gle/5d9KY9NTV85GjjyJ8).
...
* **Key**: Unique identifier to reference instance (e.g. cloud). Don't worry this is only used as a local reference to you instance connection. It's not saved on Flagbase.

...
export const updateTargetingRule = async (
    ...
    return axios.patch(`/targeting/${workspaceKey}/${projectKey}/${environmentKey}/${flagKey}/rules/${ruleKey}`, request);
}
...
export const patchTargeting = async (
    ...
    return axios.patch(`/targeting/${workspaceKey}/${projectKey}/${environmentKey}/${flagKey}`, request);
}

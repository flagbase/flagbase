...
const Modal: React.FC<ModalProps> = ({ visible, setVisible }) => {
    ...
    return (
        <ModalLayout open={visible} onClose={() => setVisible(false)} className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
            <>
                <div>
                ...
                <div className="flex flex-col gap-3 mt-3">
                    <p>
                        ...
                        <div>
                            <div className="m-2 rounded-md px-3 pt-2.5 pb-1.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                                <label htmlFor="flagKey" className="block text-xs font-medium text-gray-500">
                                    Flag Key
                                </label>
                                <input
                                    type="text"
                    ...
                    <p>
                        It's also crucial to reference the correct variation key in your code. This ensures that your
                        code behaves as expected based on the specific variation of the feature that is enabled.
                    </p>
                    ...
                    <div className="flex flex-col ">
                        ...
                        {sdks?.map((sdk) => (
                            <div key={sdk.id} className="flex flex-col">
                                ...
                                <div className="m-2 rounded-md px-3 pt-2.5 pb-1.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                                    <label htmlFor="client" className="block text-xs font-medium text-gray-500">
                                        Client SDK Key
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="m-2 rounded-md px-3 pt-2.5 pb-1.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                                    <label htmlFor="server" className="block text-xs font-medium text-gray-500">
                                        Server SDK Key
                                    </label>
                                    <input
                                        type="text"

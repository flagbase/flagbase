...
// import FlagbaseClient from '@flagbase/js-client-sdk'
...
// )
// 
// const showNewNavigation = flagbase.variation("new-navigation", "off") === "on";
// 
// render (showNewNavigation ? <NewNavigation /> : <OldNavigation />)
// 
...
const DemoAppProps: React.FC<DemoAppProps> = (props) => {
  ...
  const [showNewNavigation, setShowNewNavigation] = useState<boolean>(false);
  ...
  useEffect(() => {
    ...
    _flagbaseClient.on(EventType.CLIENT_READY, (eventMessage) => {
      ...
      setShowNewNavigation(_flagbaseClient.variation('new-navigation', "control") === "treatment");
    });
  ...
  return (
    <>
      <NavigationEntry showNewNavigation={showNewNavigation} />
